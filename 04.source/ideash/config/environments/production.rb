Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://team5.work', /http:\/\/team5.*/]
  # config.action_cable.allowed_request_origins = [ 'https://localhost', /https:\/\/localhost.*/]
  ...
  # config.active_job.queue_name_prefix = "ideash_production"
