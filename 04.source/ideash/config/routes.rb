...
#                                              /cable                                                                                   #<ActionCable::Server::Base:0x000055bbebb29808 @config=#<ActionCable::Server::Configuration:0x000055bbebc7b9b8 @log_tags=[], @connection_class=#<Proc:0x000055bbebc62f80 /home/otyua/RubymineProjects/sk2020_5K/04.source/ideash/vendor/bundle/ruby/2.7.0/gems/actioncable-6.0.3.1/lib/action_cable/engine.rb:37 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x000055bbe9724e08 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x000055bbe9725718 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x000055bbe9724d40 @datetime_format=nil, @thread_key="activesupport_tagged_logging_tags:18480">, @logdev=#<Logger::LogDevice:0x000055bbe9725290 @shift_period_suffix="%Y%m%d", @shift_size=1048576, @shift_age=0, @filename="/home/otyua/RubymineProjects/sk2020_5K/04.source/ideash/log/development.log", @dev=#<File:/home/otyua/RubymineProjects/sk2020_5K/04.source/ideash/log/development.log>, @binmode=false, @mon_data=#<Monitor:0x000055bbe9725178>, @mon_data_owner_object_id=14040>>, @cable={"adapter"=>"async"}, @mount_path="/cable", @allowed_request_origins=/https?:\/\/localhost:\d+/>, @mutex=#<Monitor:0x000055bbebb297e0>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
